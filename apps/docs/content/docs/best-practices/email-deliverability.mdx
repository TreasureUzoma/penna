...
**Key metrics:**
- **Delivery rate** - % of emails accepted by receiving servers (should be >98%)
- **Inbox placement rate** - % that reach inbox vs spam (should be >90%)
- **Bounce rate** - % that fail to deliver (should be <2%)
